...
export default function Footer() {
  ...
  <li>
    <Link href="/cabanas" className="hover:text-white transition">
      {t('cabins')}
    </Link>
  </li>
  ...
  <li>
    <Link href="/matrimonios" className="hover:text-white transition">
      {t('weddings')}
    </Link>
  </li>

  <li>
    <Link href="/colegios" className="hover:text-white transition">
      {t('schools')}
    </Link>
  </li>

  <li>
    <Link href="/empresas" className="hover:text-white transition">
      {t('companies')}
    </Link>
  </li>

  <li>
    <Link href="/touroperadores" className="hover:text-white transition">
      {t('tourOperators')}
    </Link>
  </li>
